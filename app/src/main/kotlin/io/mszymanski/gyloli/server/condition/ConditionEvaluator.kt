...
/**
 * Decides one of a team's conditions against what a run is carrying.
 *
...
class ConditionEvaluator(
    ...
    /**
     * Runs the team's function in the sandbox and takes its answer.
     *
    ...
    private fun test(condition: WorkflowCondition, input: JsonNode?): Boolean {
        ...
        return when (check) {
            ConditionCheck.IN_LIST, ConditionCheck.TEAMMATE -> condition.values.any { it.equalsIgnoringCase(value) }
