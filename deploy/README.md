...
| `ORKNUX_SERVER_TAG` | `0.7` | Which `orknux/orknux-server` image. |
| `ORKNUX_UI_TAG` | `0.7` | Which `orknux/orknux-ui` image. |
...
`compose.yaml` pins `0.7`, so what you bring up today is what you bring up next
...
Both repositories are at `0.7`/`0.7.0`, released together, and that is what
