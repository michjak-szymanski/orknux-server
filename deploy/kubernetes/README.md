...
```
kubectl -n orknux set image deploy/orknux-server orknux-server=orknux/orknux-server:0.9.8
kubectl -n orknux set image deploy/orknux-ui orknux-ui=orknux/orknux-ui:0.9.8
```
