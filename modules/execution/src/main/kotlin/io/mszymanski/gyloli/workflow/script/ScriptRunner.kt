package io.mszymanski.gyloli.workflow.script
...
/**
 * Runs a team's JavaScript.
 *
 * The code comes from whoever can edit a team's functions, so it is treated as
...
class ScriptRunner(private val properties: ScriptProperties) {
     ...
     *
     * @param source the module the team wrote; its default export is called.
    ...
    private companion object {
        ...
        const val CALLEE = "__gyloliCallee"
        const val CONTEXT = "__gyloliContext"
        const val ARGUMENTS = "__gyloliArguments"
        const val RESULT = "__gyloliResult"
        const val ERROR = "__gyloliError"
...
@ConfigurationProperties(prefix = "gyloli.script")
